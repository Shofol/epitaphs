      ...
      <div className="min-h-screen w-screen bg-primary pb-10 font-garamond">
        ...
        <main className="mx-auto max-w-7xl px-5 lg:px-0">
          <h1 className="mt-10 text-justify text-4xl text-secondary">
            Grief is personal, yet we are united by a profound ache to extend
            our time with those who have departed. We find solace in rituals
            that keep their memories alive: tracing old photographs, preserving
            voicemails, and writing letters. There is now another way help bring
            comfort and closure to those experiencing loss.
          </h1>
          ...
          <div className="grid grid-cols-3 gap-10 text-secondary">
            <div className="flex flex-col items-center">
              ...
              <p className="mt-4 text-center text-2xl">
                Share messages, audio, videos, and more that capture who they
                are
              </p>
            </div>
